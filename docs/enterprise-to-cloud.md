...
The selected versions drive four parts of the experience:
...
4. **Recommended next steps.** A sequenced list covering ownership, SCMA, apps, data, connectivity, identity, testing, cutover, monitoring, and retirement.
...
4. Test a pre-SCMA source line, a supported older source line, and the latest Enterprise source against at least two Cloud destinations.
5. Update the reviewed date and any screenshots affected by the change.

## Scope and privacy

The explorer stores selections only in the page URL so a comparison can be shared. It has no registration, contact form, analytics, tracking, or customer-data submission. Any SCMA export is produced and shared outside this site and only through an explicit customer action described by Splunk.
